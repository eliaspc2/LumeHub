...
try {
  ...
  for (const scenario of [
    {
      ...
      expectedTexts: [
        ...
        'Alt + D alterna este modo sem saires do teclado.',
      ],
    ...
    },
    {
      ...
      expectedTexts: ['Detalhes avancados', 'Auth file:'],
      forbiddenTexts: ['Algo falhou ao carregar esta pagina'],
    },
    {
  ...
  console.log(`Wave 16 validation passed on http://127.0.0.1:${previewPort}/`);
} finally {
  await shutdown();
}
...
async function waitUntilReady(url) {
  ...
  throw new Error('Timed out while waiting for the Wave 16 preview server.');
}
