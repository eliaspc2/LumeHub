...
assert.match(implementationWavesDoc, /### Wave 61 - Contratos de composicao e densidade base/u);
...
assert.match(gapAuditDoc, /Falta de contratos internos fortes de composicao/u);
assert.match(gapAuditDoc, /Espaco morto excessivo e densidade irregular/u);
