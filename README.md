...
- a `Wave 77` fechou as rotas tecnicas por papel com menos repeticao no `Workspace`, `Media` e `Watchdog`
- a validacao consolidada mais recente passou a ser `validate:wave77`
...
- a `Wave 55` ja fechou o calendario semanal como vista operacional principal, com create/edit/deactivate inline e leitura clara do estado dos lembretes
